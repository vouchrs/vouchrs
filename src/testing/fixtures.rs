...
#[must_use]
pub fn oauth_session() -> VouchrsSession {
    TestFixtures::oauth_session()
}

#[must_use]
pub fn passkey_session() -> VouchrsSession {
    TestFixtures::passkey_session()
}
...
#[must_use]
pub fn user_data() -> VouchrsUserData {
    TestFixtures::user_data()
}

#[must_use]
pub fn user_data_with_avatar() -> VouchrsUserData {
    let mut data = TestFixtures::user_data();
    data.name = Some("Test User with Avatar".to_string());
    data
}
...
pub fn api_user_agent() -> String {
    "VouchrsAPI/1.0 (API Client)".to_string()
}

#[must_use]
pub fn cookie_secret() -> String {
    TestFixtures::consistent_test_secret().to_string()
}

#[must_use]
pub fn google_session() -> VouchrsSession {
    TestFixtures::session_for_provider("google")
}

#[must_use]
pub fn github_session() -> VouchrsSession {
    TestFixtures::session_for_provider("github")
}

#[must_use]
pub fn discord_session() -> VouchrsSession {
    TestFixtures::session_for_provider("discord")
}

#[must_use]
pub fn expired_session() -> VouchrsSession {
    TestFixtures::expired_session()
}
